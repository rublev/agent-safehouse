...
# Embedded Profiles Last Modified (UTC): 2026-03-08T22:53:52Z
...
;; Local agent-browser CLI state and Chromium bootstrap glue for skill-driven
...
;; $$require=55-integrations-optional/macos-gui.sb,55-integrations-optional/shell-init.sb$$
;; ---------------------------------------------------------------------------

;; `agent-browser` keeps daemon sockets, pid files, screenshots, saved state,
;; and user defaults under ~/.agent-browser.
;;
;; Playwright's bundled chrome-headless-shell also registers a per-process
;; MachPortRendezvousServer endpoint on macOS. Without this registration grant,
;; Chromium aborts during launch inside the outer Seatbelt sandbox.
